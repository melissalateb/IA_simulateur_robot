...
public class Parameters {
  ...
  public static final double teamASecondaryBotRadius = 50, //1 unit = 1mm, body radius
                             ...
                             teamASecondaryBot1InitHeading = NORTH, //clockwise trigonometric unit, according to screen pixel coordinate reference
                             ...
                             teamASecondaryBot2InitHeading = NORTH; //clockwise trigonometric unit, according to screen pixel coordinate reference
  ...
  public static final double teamBMainBotRadius = 50, //1 unit = 1mm, body radius
                             ...
                             teamBMainBotSpeed = 10, //1 unit = 1mm, distance performed at step movement
  ...
  public static final double teamBSecondaryBotRadius = 50, //1 unit = 1mm, body radius
                             ...
                             teamBSecondaryBotSpeed = 10, //1 unit = 1mm, distance performed at step movement
